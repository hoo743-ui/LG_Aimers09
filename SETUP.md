...
| | |
|---|---|
| 최고 실측 LB | 🚩 **1049.9226** (25회차, `cand_asof_xl.zip`, 82피처) |
| 이력 | 1040.8656(22) → 1032.3182(23) → 1044.7656(24) → **1049.9226(25)** |
| 제출 예산 | **하루 5회** (기존 "슬롯 3장" 전제는 폐기됨) |
| 미제출 후보 | **없다.** 26·27회차는 음수 게이트대로 후퇴했고 이후 축은 전부 닫혔다 |
