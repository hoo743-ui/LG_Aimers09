...
|---:|---|---|---|---|---|
| 1 | `cand_kp6` | 투수 수준축 **모양** | t=−6 | `0d5ca51b02aeccd1` | ✅ 3종 |
| 2 | `cand_kp3` | 〃 | t=−3 | `57cd8f32e6b45db6` | ✅ 3종 |
| 3 | `cand_kpopt` | 〃 정점 | 1·2 로 계산 | 그때 빌드 | — |
| 4 | `cand_kbw06` | 타자 수준축 **크기** | w 2.105→1.263 | `3194bb7141e27193` | ✅ 3종 |
| 5 | `cand_kbw14` | 〃 | w 2.105→2.947 | `00dd27d25322ef42` | ✅ 3종 |
